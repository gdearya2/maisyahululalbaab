                ...
                <div class="card-body d-flex align-items-center">
                  <div class="product-thumbnail-side">
                    ...
                    <a class="product-thumbnail d-block" href="/product/{{ $product->nama_product }}">
                      <img style="height: 158px; object-fit:cover" src="{{ asset('storage/gambar_product/'. $product->gambar_product) }}" alt="">
                    </a>
                  </div>
                  <div class="product-description">
                    <a class="product-title d-block" href="/product/{{ $product->nama_product }}">{{ $product->nama_product }}</a>
