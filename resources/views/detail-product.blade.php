  ...
  @section('section')
      ...
      <div class="product-slides owl-carousel">
        <!-- Single Hero Slide-->
        <div class="single-product-slide"><img src="{{asset('storage/gambar_detailProduct1/'. $product->gambar_detailProduct1)}}" alt=""></div>
        @if ($product->gambar_detailProduct2 && $product->gambar_detailProduct3)
          <div class="single-product-slide"><img src="{{asset('storage/gambar_detailProduct2/'. $product->gambar_detailProduct2)}}" alt=""></div>
          <div class="single-product-slide"><img src="{{asset('storage/gambar_detailProduct3/'. $product->gambar_detailProduct3)}}" alt=""></div>
