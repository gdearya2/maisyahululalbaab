            ...
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card top-product-card">
                <div class="card-body">
                  ...
                  @endif
                  <a class="product-thumbnail d-block" href="/product/{{ $product->nama_product }}"><img class="mb-2"  src="{{asset('storage/gambar_product/'. $product->gambar_product)}}" alt="" /></a><a class="product-title d-block" href="/product/{{ $product->nama_product }}">{{ $product->nama_product }}</a>
                  @if ($product->harga_coret_product)
                  <p class="sale-price ">{{ $product->harga_product }}<span>{{ $product->harga_coret_product }}</span></p>
                  @else 
                  <p class="sale-price">{{ $product->harga_product }}</p>
                  @endif
