      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-lg-2 col-md-4 mt-3 ">
            ...
            <p class="p-footer2"> <a href="/category/{{ $categories[0]->nama_kategori}}">Makanan</a></p>
            <p class="p-footer2"> <a href="/category/{{ $categories[1]->nama_kategori}}">Minuman</a></p>
            <p class="p-footer2"> <a href="/category/{{ $categories[2]->nama_kategori}}">Fashion</a></p>
            <p class="p-footer2"> <a href="/category/{{ $categories[3]->nama_kategori}}">Aksesoris Muslimah</a></p>
            <p class="p-footer2"> <a href="/category/{{ $categories[4]->nama_kategori}}">Herbal</a></p>
            <p class="p-footer2"> <a href="/category/{{ $categories[5]->nama_kategori}}">Lain-lain</a></p>
          </div>
          <div class="col-lg-2 col-md-4   mt-3">
